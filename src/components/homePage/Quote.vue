<template>
    <div v-on:scroll="scrollFunction"  class="vision">
        <p class="black--text" id="statement">We are a  non-profit organization dedicated to mentoring and educating youth in robotics to discover their STEM potential.
            Our team strongly believes that with proper guidance, anyone can be successful. <br>
            <span>Get ahead with SRIL today!</span>
        </p>
        <div id="line"></div>
        <p class="black--text" id="vision"> The <span class=" blue--text">SRIL</span> Vision.</p>
    </div>
</template>
